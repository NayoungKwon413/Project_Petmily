<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<%-- /WebContent/model2/dailycare/dcupdateForm.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="EUC-KR">
...
<tr><th colspan="2"><input type="submit" value="수정" id="submit"><input type="button" value="취소" onclick="window.close()"></th></tr>
</table></div>
</form>
</body>
</html>